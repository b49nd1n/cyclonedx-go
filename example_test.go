...
import (
	...
	cdx "github.com/b49nd1n/cyclonedx-go"
)
...
func Example_encode() {
	...
	components := []cdx.Component{
		{
			BOMRef:     "pkg:golang/github.com/b49nd1n/cyclonedx-go@v0.3.0",
			Type:       cdx.ComponentTypeLibrary,
			Author:     "CycloneDX",
			Name:       "cyclonedx-go",
			Version:    "v0.3.0",
			PackageURL: "pkg:golang/github.com/b49nd1n/cyclonedx-go@v0.3.0",
		},
	}
	...
	dependencies := []cdx.Dependency{
		{
			...
			Dependencies: &[]string{
				"pkg:golang/github.com/b49nd1n/cyclonedx-go@v0.3.0",
			},
		},
		{
			Ref: "pkg:golang/github.com/b49nd1n/cyclonedx-go@v0.3.0",
		},
	}
	...
	//   </metadata>
	//   <components>
	//     <component bom-ref="pkg:golang/github.com/b49nd1n/cyclonedx-go@v0.3.0" type="library">
	//       <author>CycloneDX</author>
	//       <name>cyclonedx-go</name>
	//       <version>v0.3.0</version>
	//       <purl>pkg:golang/github.com/b49nd1n/cyclonedx-go@v0.3.0</purl>
	//     </component>
	//   </components>
	//   <dependencies>
	//     <dependency ref="pkg:golang/acme-inc/acme-app@v1.0.0">
	//       <dependency ref="pkg:golang/github.com/b49nd1n/cyclonedx-go@v0.3.0"></dependency>
	//     </dependency>
	//     <dependency ref="pkg:golang/github.com/b49nd1n/cyclonedx-go@v0.3.0"></dependency>
	//   </dependencies>
	// </bom>

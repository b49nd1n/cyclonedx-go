...
func ExampleNewBOMLink() {
	...
	bom.Metadata = &cdx.Metadata{
		Component: &cdx.Component{
			BOMRef:     "pkg:golang/github.com/b49nd1n/cyclonedx-go@v0.5.0?type=module",
			Type:       cdx.ComponentTypeLibrary,
			Name:       "github.com/b49nd1n/cyclonedx-go",
			Version:    "v0.5.0",
			PackageURL: "pkg:golang/github.com/b49nd1n/cyclonedx-go@v0.5.0?type=module",
		},
	}
